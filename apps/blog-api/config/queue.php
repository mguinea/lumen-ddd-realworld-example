...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Route your commands, queries and events to the connections.
    |
    */

    'routing' => [
        \App\Blog\User\Application\GetUserByIdQuery::class => [
            'connection' => 'sync',
            'queue' => 'default',
            'delay' => 0
        ],
        \App\Blog\User\Application\RegisterUserCommand::class => [
            'connection' => 'sync',
            'queue' => 'default',
            'delay' => 0
        ],
