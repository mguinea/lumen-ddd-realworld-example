    ...
    */
    ...
    'connections' => [
        ...
        'mysql_blog' => [
            ...
            'unix_socket' => env('BLOG_DB_SOCKET', ''),
            'charset' => env('BLOG_DB_CHARSET', 'utf8mb4'),
            'collation' => env('BLOG_DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => env('BLOG_DB_PREFIX', ''),
            'strict' => env('BLOG_DB_STRICT_MODE', true),
            'engine' => env('BLOG_DB_ENGINE', null),
            'timezone' => env('BLOG_DB_TIMEZONE', '+00:00'),
        ],
